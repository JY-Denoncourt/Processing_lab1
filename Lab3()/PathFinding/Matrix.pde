...
abstract class Matrix {
  ...
  //GETTER SETTER============================================================================
  int getCellColFromMouse(int x) {return int(float(x) / cellWidth);}
  int getCellRowFromMouse(int y) {return int(float(y) / cellHeight);}
  Cell getCell (int i, int j) {return cells.get(j).get(i);}
  
  void setCellColor (int i, int j, color c) {cells.get(j).get(i).setFillColor(c);}
